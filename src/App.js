...
const dataTour = [
  { 
    text: "6월이벤트", 
    image:"https://images.unsplash.com/photo-1662522229766-fb5abaa9de6d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDE5fE1yNDlFdmg1U2tzfHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=800&q=60"
  },
  { 
    text: "7월이벤트", 
    image:"https://images.unsplash.com/photo-1682492155376-2c42571da722?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDI3fE1yNDlFdmg1U2tzfHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=500&q=60"
  },
  { 
    text: "8월이벤트", 
    image:"https://images.unsplash.com/photo-1601815560619-c5aeb2cb9297?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDI5fE1yNDlFdmg1U2tzfHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=500&q=60"
  },
]
function App() {
  return (
                  ...
                  .map((item, i) => (
                    <GridItem
                      ...
                      <Box
                        ...
                        w="full"
                        h="120px"
                        bgGradient="linear(to-b, rgba(255,255,255,0.0),rgba(255,255,255,0.9))"
                      >
                        <Text
                          w="full"
                          align="center"
